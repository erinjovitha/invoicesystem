# Generated by Django 5.1.2 on 2024-10-13 16:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line_two_total_price', models.IntegerField(blank=True, default=0, null=True, verbose_name='Total Price (D)')),
                ...
                ('line_three_total_price', models.IntegerField(blank=True, default=0, null=True, verbose_name='Total Price (D)')),
                ...
                ('line_four_total_price', models.IntegerField(blank=True, default=0, null=True, verbose_name='Total Price (D)')),
                ...
                ('line_five_total_price', models.IntegerField(blank=True, default=0, null=True, verbose_name='Total Price (D)')),
                ...
                ('invoice_type', models.CharField(blank=True, choices=[('Proforma Invoice', 'Proforma Invoice'), ('Receipt', 'Receipt'), ('Invoice', 'Invoice')], default='Invoice', max_length=50, null=True)),
            ],
        ),
    ]
