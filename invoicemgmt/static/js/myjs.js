$(document).ready(function(){
    ...
    $('#id_line_one_quantity,#id_line_one_unit_price,#id_line_two_quantity,#id_line_two_unit_price,#id_line_three_quantity,#id_line_three_unit_price,#line_four_quantity,#id_line_four_unit_price,#id_line_five_quantity,#id_line_five_unit_price,#line_six_quantity,#id_line_six_unit_price,#id_line_seven_quantity,#id_line_seven_unit_price,#line_eight_quantity,#id_line_eight_unit_price,#id_line_nine_quantity,#id_line_nine_unit_price,#line_ten_quantity,#id_line_ten_unit_price').keyup(function(){
        ...
        $('#id_line_one_total_price').val(line_one_total || 0);
        $('#id_line_two_total_price').val(line_two_total || 0);
        $('#id_line_three_total_price').val(line_three_total || 0);
        $('#id_line_four_total_price').val(line_four_total || 0);
        $('#id_line_five_total_price').val(line_five_total || 0);
        $('#id_line_six_total_price').val(line_six_total || 0);
        $('#id_line_seven_total_price').val(line_seven_total || 0);
        $('#id_line_eight_total_price').val(line_eight_total || 0);
        $('#id_line_nine_total_price').val(line_nine_total || 0);
        $('#id_line_ten_total_price').val(line_ten_total || 0);
        $('#id_total').val(total || 0);
